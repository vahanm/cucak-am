...
function wp_nav_menu( $args = array() ) {
	...
	foreach ( (array) $menu_items as $key => $menu_item )
	{
		...
		$sorted_menu_items[$menu_item->menu_order]->title = __($sorted_menu_items[$menu_item->menu_order]->title);
		$sorted_menu_items[$menu_item->menu_order]->post_excerpt = __($sorted_menu_items[$menu_item->menu_order]->post_excerpt);
