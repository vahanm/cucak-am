...
?>
    ...
    <body>
        <h1><?php echo /*WP_I18N_MAINT_MSG*/'Site briefly unavailable for scheduled maintenance. Check back in a minute.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
        <h1><?php echo /*WP_I18N_MAINT_MSG*/'Сайт недоступен на короткое время для планового обслуживания. Перепроверьте через минуту.'/*/WP_I18N_MAINT_MSG*/; ?></h1>
        <h1><?php echo /*WP_I18N_MAINT_MSG*/'Կայքը կարճ ժամանակով անհասանելի է պլանային սպասարկման համար։ Կրկին փորձեք մեկ րոպեից։'/*/WP_I18N_MAINT_MSG*/; ?></h1>
    </body>
    </html>
<?php
    die();
