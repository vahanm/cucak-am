 ...
 * 
 * 			jQuery.post( ajaxurl, {
 *				action: 'my_ba_integration_action',
 *				'cookie': encodeURIComponent(document.cookie),
 *				'parameter_1': 'some_value'
 *			}, function(response) { ... } );
 *
 * Notice the action 'my_ba_integration_action', this is the part that will hook into the wp_ajax action.
 * 
 * You will need to add an add_action( 'wp_ajax_my_ba_integration_action', 'the_function_to_run' ); so that
