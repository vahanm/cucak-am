...
function bp_ba_integration_register_widgets() {
	add_action('widgets_init', create_function('', 'return register_widget("BP_BA_Intergration_Widget");') );
}
add_action( 'plugins_loaded', 'bp_ba_integration_register_widgets' );

class BP_BA_Intergration_Widget extends WP_Widget {

	function bp_ba_integration_widget() {
	...
	function form( $instance ) {
		...
		<p><label for="bp-ba-integration-widget-per-page"><?php _e( 'Number of Items Per Page:', 'bp-ba-integration' ); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'per_page' ); ?>" name="<?php echo $this->get_field_name( 'per_page' ); ?>" type="text" value="<?php echo attribute_escape( $per_page ); ?>" style="width: 30%" /></label></p>
		<p><label for="bp-ba-integration-widget-max"><?php _e( 'Max items to show:', 'bp-ba-integration' ); ?> <input class="widefat" id="<?php echo $this->get_field_id( 'max_items' ); ?>" name="<?php echo $this->get_field_name( 'max_items' ); ?>" type="text" value="<?php echo attribute_escape( $max_items ); ?>" style="width: 30%" /></label></p>
	<?php
	}
}
