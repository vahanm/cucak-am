...
helper_group('building_information', __('Building information'));

helper_location('item_location', __('Flat location'), USER_LOCATION);

helper_text("address", __('Address'), __('Please enter the address.'));

helper_slider_by_list('structureyear', __('Year of the structure'), __('Please select'), 1940, date('Y'), __('%sy'), array(1940 => __('%sy or older')
...
helper_slider_by_list('floornumber', __('Floor number'), __('Please select'), 1, 30, __('%s floornumber'), array(
	1 =>  __('%s floornumberone')
	),  __('%s floornumberone'), __('%s floornumber') );

helper_radio('bulidingmodel', __('Buliding model'), array( 
...
helper_yes_no("rubbish", __('Rubbish chute'), true);
...
helper_group('flat_information', __('Flat'));
...
helper_yes_no("cellar", __('Cellar'));
