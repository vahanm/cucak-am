...
//	$error .= require_selection('item_condition', __('Please select the item condition.'));
	...
	$error .= require_oneof(
		require_selection('truckmodel', __('Please enter the model.')),
		require_length_min('truckmodel', 2, __('Model is invalid.')),
		require_length_max('truckmodel', 30, _t('Model must be contents %s chars maximum.',30))
		);
	...
	$error .= require_selection('bodystyle', __('Please select the body type.'));
...
//	$error .= require_selection('thecountry', __('Please select the country.'));
	...
	$error .= require_selection('carcolor', __('Please select the truck color.'));	
