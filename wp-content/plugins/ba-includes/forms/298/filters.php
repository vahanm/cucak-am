...
//filter_text("truckmodel", __('Truck model'), __('Please enter the model.'));
...
//filter_slider('motorpower', __('Motor power'), __('Please select'), 2, 75, 350, __('%s h/p'));
...
filter_colors(array(
	'id'			=>'carcolor'
	, 'title'		=>__('Truck color')
	, 'priority'	=>	PRIMARY_FILTER
	));


//filter_colors('truckcolor', __('Truck color'));
 /*
filter_select('painttype', __('Paint type'), array( 
	...
	*/
/*
filter_select('truckcolor', __('Truck color'), array( 
