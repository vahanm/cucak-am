...
helper_location('item_location', __('Truck location'), USER_LOCATION);
...
helper_text("truckmodel", __('Truck model'), __('Please enter the model.'));
...
//helper_slider('motorpower', __('Motor power'), __('Please select'), 2, 75, 350, __('%s h/p'));
...
helper_colors('carcolor', __('Truck color'));
 /*
helper_radio('painttype', __('Paint type'), array( 
	...
	*/
/*
helper_select('truckcolor', __('Truck color'), array( 
