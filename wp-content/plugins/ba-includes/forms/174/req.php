...
function get_form_errors()
{
	...
	$error .= require_oneof(
		require_selection('tabletmodel', __('Please enter the model.')),
		require_length_min('tabletmodel', 3, __('Model is invalid.')),
		require_length_max('tabletmodel', 30, _t('Model must be contents %s chars maximum.',30))
		);
