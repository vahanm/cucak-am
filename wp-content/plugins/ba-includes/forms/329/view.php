...
render_value('imagesensor', __('Image sensor size'), 'Error', array(
	...
	'4500' =>'45x30' .__('mm') . ' - Leica S',
	'4400' =>'44x33' .__('mm') . ' - Pentax 645D',
	'4900' =>'49x36.8' .__('mm') . ' - Kodak KAF 39000 CCD',
	'5600' =>'56x36' .__('mm') . ' - Leaf AFi 10',
	'5390' =>'53.9x40.4' .__('mm') . ' - Phase One P 65+, IQ160, IQ180',
	'other' =>__('other')
	));
...
render_value('continuousshootingraw', __('Continuous shooting (RAW)'), __('%s shots per second'));
