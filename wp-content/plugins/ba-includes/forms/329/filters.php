...
filter_slider('continuousshootingraw', __('Continuous shooting (RAW)'), 0.1, 1, 100, __('%s shots/s'));

filter_slider_by_list(array(
  'id'			=>'isosensitivity'
, 'title'		=>__('ISO sensitivity')
, 'min'			=>1
, 'max'			=>10
, 'format'		=>__('%1 - %2')
, 'text'		=>'%s'
...
filter_select('videores', __('Video recording'), array( 
...
//filter_yes_no("multitouch", __('Multitouch'), true);
