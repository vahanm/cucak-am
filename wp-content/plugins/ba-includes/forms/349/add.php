...
helper_location('item_location', __('Minibus location'), USER_LOCATION);
...
*/
helper_carmodels();
//helper_text("minibusmodel", __('Minibus model'), __('Please enter the model.'));
...
helper_slider_by_list('yearcar', __('Year'), __('Please select'), 1980, date('Y'), __('%sy'), array(1980 => __('%sy or older')
	), __('%sy or older', 1980), date('Y') . __('y'));
...
helper_slider('seatsquantity', __('Seat quantity'), __('Please select'), 1, 2, 25,  __('%s seats'));
/*
...
//helper_slider('motorpower', __('Motor power'), __('Please select'), 2, 30, 300, __('%s h/p'));
...
/*
helper_select('minicolor', __('Minibus color'), array( 
...
*/
helper_colors('carcolor', __('Minibus color'));
...
helper_slider('discs', __('Discs'), __('Please select'), 0.5, 28, 44, '%s \"', '14 &#34;', '35 &#22;' );

helper_yes_no("tintedglass", __('Tinted glasses'));
