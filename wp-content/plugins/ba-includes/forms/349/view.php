...
render_location('item_location', __('Minibus location'));
/*
...
*/
//render_value('carmodel', __('Car model'), '%s' );	
//render_value('minibusmodel', __('Minibus model'), '%s' );		
...
/*
render_value('carbrandname', __('Car brand'), '%s' );	

render_value('carmodelname', __('Car model'), '%s' );	
*/
...
render_value('seatsquantity', __('Seat quantity'), __('%s seats'));	  
...
render_yes_no("hydraulicrudder", __('Power assisted steering'));




//render_group_sub(__('Driving comforts'));
...
render_color('carcolor', __('Minibus color'));
...
/*render_value('minicolor', __('Minibus color'), 'Error', array(
	'1' => __('White'),
	'2' => __('White metallic'),
	'3' => __('Black'),
	'4' => __('Black metallic'),
