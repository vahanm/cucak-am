...
render_location('item_location', __('Bus location'));
/*
...
render_value('busmodel', __('Bus model'), '%s' );		
...
render_yes_no("toilet", __('Toilet'));
...
render_color('carcolor', __('Bus color'));
...
/*		
render_value('buscolor', __('Bus color'), 'Error', array(
	'1' => __('White'),
	'2' => __('White metallic'),
	'3' => __('Black'),
	'4' => __('Black metallic'),
...
render_yes_no("rearvisioncam", __('Rear vision camera'), true);

render_yes_no("mirrorsheating", __('Mirrors heating'));

//render_yes_no("rearwindowdefroster", __('Rear window defroster'));
...
render_yes_no("mp3player", __('MP3 player'), true);
