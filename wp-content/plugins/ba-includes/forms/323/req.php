...
function get_form_errors()
{
	...
	//$error .= require_selection('tvtype', __('Please select the type.'));
	
	$error .= require_length_min('tvmodel', 2, __('Model is invalid.'));
	$error .= require_length_max('tvmodel', 30, _t('Model must be contents %s chars maximum.',30));
