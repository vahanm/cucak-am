...
function get_form_errors()
{
	...
	$error .= require_selection_of_one('shoestofferedto', array('men', 'women'), __('Please select to whom accessory is offered.'));
	
	$error .= require_selection_of_one('accessorytype', array(
		'scarf',
		'glove',
		'belt',
		'tie',
		...
		'sunglasses',
		'watch', 
		'other'), __('Please select the accessory type.'));
