...
<head>
    ...
    <link rel="stylesheet" id="google-images-style-css"  href="http://test.cucak.am/addnew/google-images/style.css?ver=1.0" type="text/css" media="all" />
    <script type="text/javascript" src="http://cucak.am/addnew/google-images/script.js?ver=1.0"></script>
</head>
<body>
    <h1 class="google-images-label">Google Images</h1>
    <form>
